                        ...
                        <form class="form-inline" action="dbFetch.php" method="post">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="inlineFormInputGroupUsername"
                                        placeholder="Favourite Colour" name="sq1" required>
                                </div>
                                <br>
                                <div class="input-group">
                                    <div class="input-group-prepend inpcred">
                                    ...
                                    <input type="text" class="form-control" id="inlineFormInputGroupUsername"
                                        placeholder="Favourite Movie" name="sq2" required>
                                </div>
                            </div>
                            <br>
                            <input type="submit" value="Recover Account" name="reacc" class="btn btn-outline-success btn-lg reAc">
                        </form>
                    </div>
                </div>
            </div>
